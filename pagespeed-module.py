...
import os, sys, apt, re, shutil, time
...
def download(url):
	...
	remote_file = urlopen(urlopen(url).geturl())
...
if __name__ == "__main__":
	...
	html = urlopen("https://www.modpagespeed.com/doc/release_notes").read().decode('utf-8')
